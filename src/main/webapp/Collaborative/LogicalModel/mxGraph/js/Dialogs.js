 ...
 */
var LogicalTasksSaveDialog=function(editorUi){
    var div = document.createElement("div");
    div.style.textAlign = "center";

    var head=document.createElement('h1');
    head.innerHTML="Save Task";
    ...
    var okBtn = mxUtils.button(mxResources.get('ok'), function()
    {
		...
		dataJSON["GraphXML"]=graph.getMxgraphListXMLStr();
		dataJSON["LogicalXML"]=graph.getLogicalSceneXMLStr();
        dataJSON["CID"]=groupID;
        $.ajax({
            type: "POST",
            url: "/TeamWorking/MxGraphServlet",
