...
Toolbar.prototype.init = function()
{
...

	{
        ...
        openBtn2.onclick = function () {
            editorUi.showDialog(new OpenNewFile2(editorUi).container, 320, 80, true, true, function()
            {
                window.openFile = null;
            });
        };
        ...
        button.setAttribute("title","Download MxgraphList");
        ...
        button.onclick = function () {
			...
			var mxgraphListXMLStr=graph.getMxgraphListXMLStr();
            var blob = new Blob([mxgraphListXMLStr], {type: "text/plain;charset=utf-8"}),
            fileName = 'mxgraphList.mdl';
        ...
        button2.className = "geButton";
        button2.style.textAlign = "center";
        button2.setAttribute("title","Download LogicalScene");
        var saveIcon2 = document.createElement("i");
        saveIcon2.className = "fa fa-download";
        saveIcon2.style.width ="21px";
        saveIcon2.style.height ="21px";
        saveIcon2.style.lineHeight = "24px";
        saveIcon2.style.fontSize = "16px";
		button2.appendChild(saveIcon2);
		button2.onclick = function () {
			...
			var logicalSceneXMLStr=graph.getLogicalSceneXMLStr();
            var blob = new Blob([logicalSceneXMLStr], {type: "text/plain;charset=utf-8"}),
            fileName = 'logicalScene.mdl';
            if (window.navigator.msSaveOrOpenBlob) {
                navigator.msSaveBlob(blob, fileName);
            } else {
                var link = document.createElement('a');
