...
Format.prototype.refresh = function()
{
	...
	if (graph.isSelectionEmpty())
	{
        ...
        mxUtils.write(label, "Computable Model");
	...
	else
	{
		...
		var  type =  selection.style.shape.substr(18);
...
DiagramFormatPanel.prototype.init = function()
{
	...
	panel.appendChild(this.createTitle("Name"));
    ...
    panel.appendChild(this.createTitle("Description"));
    ...
    button.onclick = function(){
        LogicalModel.basicInfo.name = input.value;
        LogicalModel.basicInfo.description = textArea.value;
