...
Editor = function(chromeless, themes, model, graph, editable)
{
	...
	this.status = '';
	this.graph.mxgraphList=[];
	this.graph.logicalScene={};
	var modelItems=[];
	var dataItems=[];
	var conditionItems=[];
	var operations=[];
	var dependencies=[];
	this.graph.logicalScene.modelItems=modelItems;
	this.graph.logicalScene.dataItems=dataItems;
	this.graph.logicalScene.conditionItems=conditionItems;
	this.graph.logicalScene.operations=operations;
	this.graph.logicalScene.dependencies=dependencies;

	this.graph.computationalScene={};
	var dataInstances=[];
	var modelInstances=[];
	this.graph.computationalScene.dataInstances=dataInstances;
	this.graph.computationalScene.modelInstances=modelInstances;

	var newMxgraph={};
	newMxgraph.uid="basicXML";
	newMxgraph.graphXML="";
