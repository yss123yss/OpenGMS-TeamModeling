...
Toolbar.prototype.init = function()
{
    ...
    if (sw >= 320)
    {
        var elts = this.addItems(['ExportImage']);
        elts[0].setAttribute('title', 'Export Image');
    }
    ...
    //     showGraph(graph,ev.data);
    //
    // };
    //
    //     // $.ajax({
    //     //     type: "POST",
    //     //     url: "/TeamModeling/MxGraphServlet",
    //     //     // Servlet
    //     //     data: "xml="+Integration,
    //     //     dataType : "",
