...
/**
 * Get conceptual scene string in type XML
 */
Graph.prototype.getConceptualSceneStr=function(){
	//生成UID
	function createUUID () {
	...
	for(var i=0;i<graph.conceptItemList.length;i++){
		...
		var localizations=XMLDoc.createElement("Localizations");
		...
		conceptItem.appendChild(localizations);
	...
	return ConceptualSceneXMLStr;
}

Graph.prototype.setConceptItemList=function(Str){
...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		HoverIcons.prototype.terminalHandle = (!mxClient.IS_SVG) ? new mxImage(IMAGE_PATH + '/handle-terminal.png', 17, 17) :
			Graph.createSvgImage(18, 18, '<circle cx="9" cy="9" r="5" stroke="#fff" fill="#007dfc" stroke-width="1"/><circle cx="9" cy="9" r="2" stroke="#fff" fill="#007dfc"/>');
