 ...
 */
var ConceptTasksReadDialog=function(editorUi){
    ...
    var okBtn = mxUtils.button(mxResources.get('ok'), function()
    {
    	if ($('input[name="tasks"]:checked').val()){
			...
			showGraph(editorUi.toolbar.editorUi.editor.graph, taskData[$('input[name="tasks"]:checked').val()]["GraphXML"]);
			editorUi.toolbar.editorUi.editor.graph.setConceptItemList(taskData[$('input[name="tasks"]:checked').val()]["ConceptXML"]);
